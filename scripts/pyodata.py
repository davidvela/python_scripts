...
# Example of batch request that contains simple entity query as well as changest consisting of two requests for entity modification
...
# Error handling
# PyOData returns HttpError when the response code does not match the expected code.
...
# The most often problem that we had to deal with was an invalid ValueList annotion pointing to a non-existing property.
